...
import com.example.user.sistempakarmotor.adapters.GejalaItemAdapter;
        ...
        btnDiagnosa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(checked.size() <= listgejalas.size()) {
                    ...
                    Intent i = new Intent(DiagnosaActivity.this, DiagnosaHasil.class);
                    Bundle b = new Bundle();
                    ...
                    Toast.makeText(DiagnosaActivity.this, "Gejala tidak boleh dipilih semua", Toast.LENGTH_SHORT).show();
                }
            }
        });
